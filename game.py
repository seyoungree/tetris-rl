...
class TetrisGame:
	def __init__(self, width=10, height=20, block_size=20, 
				render_mode='rgb_array', gravity_fps=2, render_fps=30, queue_size=5, seed=None):
	...
	def reset(self):
		...
		self.lines_cleared_this_step = 0 
		self.piece_queue = [self.rng.choice(SHAPE_NAMES) for _ in range(self.queue_size)]
		self.spawn_piece()
	...
	def spawn_piece(self):
		...
		self.piece_queue.append(self.rng.choice(SHAPE_NAMES))
